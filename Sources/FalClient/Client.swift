...
/// Controls the CDN lifecycle for files generated by a request or uploaded to storage.
public struct FalObjectLifecyclePreference: Equatable, Sendable {
    /// The number of seconds files should remain available.
    public let expirationDuration: TimeInterval

    /// Creates a file lifecycle preference.
    /// - Parameter expirationDuration: The number of seconds files should remain available.
...
public struct RunOptions: RequestOptions, Sendable {
    ...
    /// CDN lifecycle preference for files generated by this request.
